            ...
            <div className='ProfilesNavigationBar'>

                {
                    this.props.type === "operationProfile"
                        ...
                        (
                            <div className='ProfilesNavigationBar-container'>
                                <button className={this.props.postsActive && "active"} onClick={() => this.props.SwitchSlider("Notes")}><img src={postsIcon} width="24" />Notes</button>
                                <button className={this.props.targetsActive && "active"} onClick={() => this.props.SwitchSlider("Targets")}><img src={targetIcon} width="24" />Relations</button>
                                <button className={this.props.tasksActive && "active"} onClick={() => this.props.SwitchSlider("Tasks")}><img src={tasksIcon} width="24" />Related By</button>
                                <button className={this.props.settingsActive && "active"} onClick={() => this.props.SwitchSlider("Settings")}><img src={settingsIcon} width="24" />Settings</button>
                            </div>
                        )
                }
